# Generated by Django 2.1.7 on 2019-04-18 12:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='userinfo.Userinfo', verbose_name='用户')),
            ],
            options={
                'verbose_name': '订单信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_info', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='order.OrderInfo', verbose_name='订单信息')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='homegoods.GoodsInfo', verbose_name='商品SKU')),
            ],
            options={
                'verbose_name': '商品订单',
